...
ldapadduser "$FIRST_NAME" "$LAST_NAME" $USERLOGIN $USERID $GIDNUMBER aws_cellar=y -dry -v
...
5. Upload the new ldap data to aws
-----------------------------------
...
9. Grant ssh access from the user'oppc to the aws management hosts (opvmwsaws01 and opvmwsaws02)
-------------------------------------------------------------------------------------------------

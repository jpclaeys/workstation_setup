...
echo "dd if=/dev/mapper/${VM_NAME}_t1_system1 of=/dev/mapper/${VM_NAME}_vmax3_t1_system1 bs=64K conv=noerror,sync status=progress"
echo "dd if=/dev/mapper/${VM_NAME}_t1_data1   of=/dev/mapper/${VM_NAME}_vmax3_t1_data1   bs=64K conv=noerror,sync status=progress"
...
---------------------------------------------------------
comment ot or delete the multipath lines of the previous LUNs and do a service reload again :
# remove old devices
...
/home/admin/bin/removelun_rhel ${VM_NAME}_t1_system1
# if ok, then execute the cmds
/home/admin/bin/removelun_rhel ${VM_NAME}_t1_system1 | bash

/home/admin/bin/removelun_rhel ${VM_NAME}_t1_data1
# if ok, then execute the cmds
/home/admin/bin/removelun_rhel ${VM_NAME}_t1_data1 | bash
